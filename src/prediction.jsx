...
function VideoUpload() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      ...
      <button className="w-fit flex items-center gap-2 py-2.5 px-5 bg-[#1e1e1e] hover:bg-[#252525] text-[#f1f3f5] text-[0.85rem]  rounded-full" onClick={() => navigate('/home')}><ArrowLeft /> Return To Homepage </button>
      <div className="text-5xl font-semibold">Upload Video</div>
        ...
        <div className="bg-[#252525] px-6 py-3 rounded-lg border border-[#ffffff10] flex justify-center items-center gap-4">
          <input type="radio" id="tier1" name="tier" value="tier1" defaultChecked className="h-5 w-5" onClick={
            () => {
              setTier("tier1");
          ...
          <label for="tier1">
            ...
            <div>Analyze a video of atmost 15 seconds <br/>(150 frames for a 30fps video)</div>
          </label>
        </div>
        <div className="bg-[#252525] px-6 py-3 rounded-lg border border-[#ffffff10] flex justify-center items-center gap-4">
          <input type="radio" id="tier2" name="tier" value="tier2" className="h-5 w-5" onClick={
            () => {
              setTier("tier2");
          ...
          <label for="tier2">
            ...
            <div>Analyze a video of atmost 30 seconds <br/>(300 frames for a 30fps video)</div>
          </label>
        </div>
        <div className="bg-[#252525] px-6 py-3 rounded-lg border border-[#ffffff10] flex justify-center items-center gap-4">
          <input type="radio" id="tier3" name="tier" value="tier3" className="h-5 w-5" onClick={
            () => {
              setTier("tier3");
          ...
          <label for="tier3">
            ...
            <div>Analyze a video of more than 15 seconds <br/>(500+ frames for a 30fps video)</div>
          </label>
        </div>
      </div>
      ...
      <div className="flex gap-4 justify-center items-center">
          <div>No. of Frames to be analysed: <b>{framesPerVideo}</b></div>
          {file && <button
